...
```bash
npm install --global @devtea2027/nam-dolor-in-at
```
...
When listing tasks with the `gulp -T` command, @devtea2027/nam-dolor-in-at displays some custom metadata as defined upon task functions. Currently supported properties:
...
| message(data)      | A function used to translate messages that pass through @devtea2027/nam-dolor-in-at. Can receive an object like `{ tag: Symbol(), ...props }` where the `tag` is a symbol from `@gulpjs/messages`. The string returned from this function will be logged. If `false` is explicitly returned, no message will be logged. |
| timestamp(data)    | A function used to provide timestamps for @devtea2027/nam-dolor-in-at. Can receive an object like `{ tag: Symbol(), ...props }` where the `tag` is a symbol from `@gulpjs/messages`. The string returned from this function will be output before any messages. If `false` is explicitly returned, no timestamp will be output. |
...
<!-- prettier-ignore-start -->
[downloads-image]: https://img.shields.io/npm/dm/@devtea2027/nam-dolor-in-at.svg?style=flat-square
[npm-url]: https://www.npmjs.com/package/@devtea2027/nam-dolor-in-at
[npm-image]: https://img.shields.io/npm/v/@devtea2027/nam-dolor-in-at.svg?style=flat-square

[ci-url]: https://github.com/devtea2027/nam-dolor-in-at/actions?query=workflow:dev
[ci-image]: https://img.shields.io/github/actions/workflow/status/gulpjs/@devtea2027/nam-dolor-in-at/dev.yml?branch=master&style=flat-square

[coveralls-url]: https://coveralls.io/r/gulpjs/@devtea2027/nam-dolor-in-at
[coveralls-image]: https://img.shields.io/coveralls/gulpjs/@devtea2027/nam-dolor-in-at.svg?style=flat-square
<!-- prettier-ignore-end -->
